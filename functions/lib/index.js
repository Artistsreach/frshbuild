...
exports.addCreditsOnPayment = exports.addCredits = exports.getUserCredits = exports.chatWithCredits = exports.initializeUser = void 0;
...
exports.chatWithCredits = functions.https.onCall(async (data, context) => {
    var _a;
    ...
    try {
        ...
        const currentCredits = ((_a = userCreditsSnap.data()) === null || _a === void 0 ? void 0 : _a.credits) || 0;
...
exports.getUserCredits = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        return { credits: ((_a = userCreditsSnap.data()) === null || _a === void 0 ? void 0 : _a.credits) || 0 };
    }
    catch (error) {
...
exports.addCreditsOnPayment = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
...
async function processChatMessage(messages) {
    ...
    const userMessage = (lastMessage === null || lastMessage === void 0 ? void 0 : lastMessage.content) || '';
    // Mock AI response
